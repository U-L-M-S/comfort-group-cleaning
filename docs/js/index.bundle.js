  ...
  (n.n = function (e) {
    ...
    (function () {
      ...
      const O = [
          ...
          {
            description: "We wash the sink and the stove",
            reverse: !0,
            styles: {
              base: {
                width: "60px",
          ...
          {
            description: "We wash the appliances",
            reverse: !1,
            styles: {
              base: {
                width: "76px",
          ...
          {
            description:
              "We wipe the windowsills, radiators, baseboards, doors and switches!",
            reverse: !1,
            styles: {
        ...
        H = [
          {
            description: "We vacuum and we wash the floor",
            reverse: !1,
            styles: {
              base: {
                width: "90px",
          ...
          {
            description: "We wipe dust from all open and closed surfaces",
            reverse: !0,
            styles: {
              base: {
                width: "120px",
          ...
          {
            description: "We clean and take out the trash",
            reverse: !1,
            styles: {
              base: {
                width: "90px",
          ...
          {
            description:
              "We wash windows, windowsills, radiators, baseboards, switches, door handles, chandeliers",
            reverse: !1,
            styles: {
              base: {
                width: "120px",
          ...
          {
            description: "We arrange shoes and pack your belongings",
            reverse: !1,
            styles: {
              base: {
                width: "99px",
          ...
          {
            description: "We make beds and change bed linens",
            reverse: !1,
            styles: {
              base: {
                width: "120px",
        ...
        I = [
          {
            description: "We wash the floor та плінтуса, пилососимо",
            reverse: !1,
            styles: {
              base: {
                bottom: "10px",
          ...
          {
            description: "We clean and disinfect the toilet",
            reverse: !1,
            styles: {
              base: {
                bottom: "55px",
          ...
          {
            description: "We clean all surfaces",
            reverse: !0,
            styles: {
              base: {
                bottom: "20px",
          ...
          {
            description: "We clean the bathtub, faucets and shower",
            reverse: !1,
            styles: {
              base: {
                top: "10px",
      ...
      const F = [
        ...
        {
          name: "Павло Мельник",
          text: "After renovation моя квартира виглядає як нова завдяки відмінному прибиранню. Кожний куточок був ретельно вимитий, і відчуття чистоти, коли ти входиш в це житло, просто неймовірне.",
          rating: 5,
        },
        {
          name: "Ігор Коваль",
        ...
        },
        {
          ...
          text: "After renovation моя квартира стала ідеально чистою, Comfort Group уважні до всіх деталей, прибрали всі сліди ремонту і навіть не залишили жодної пилинки - це вражає!",
          rating: 5,
        },
        {
          name: "Олексій Гнатюк",
      ...
      const J = {
        ...
        summer: [
          ...
          },
          {
            ...
            description:
              "Прийміть рішення про перемогу над брудом цього літа! Отримайте 15% знижки на прибирання Вашого дому After renovation.",
